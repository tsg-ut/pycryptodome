...
def make_test_max():
    ...
    print("    convert_from_radix255(x2_out, x2);")
    print("    convert_from_radix255(z2_out, z2);")
    print("    convert_from_radix255(x3_out, x3);")
    print("    convert_from_radix255(z3_out, z3);")
    print("    reduce_25519(x2_out);")
    print("    reduce_25519(z2_out);")
    print("    reduce_25519(x3_out);")
    print("    reduce_25519(z3_out);")
...
def make_test(x2, z2, x3, z3, xp):
    ...
    print("    convert_to_radix255(x2, x2_in);")
    print("    convert_to_radix255(z2, z2_in);")
    print("    convert_to_radix255(x3, x3_in);")
    print("    convert_to_radix255(z3, z3_in);")
    print("    convert_to_radix255(xp, xp_in);")
...
print("void convert_from_radix255(uint64_t out[4], const uint32_t in[10]);")
print("void convert_to_radix255(uint32_t out[10], const uint64_t in[4]);")
print("void reduce_25519(uint64_t x[4]);")
